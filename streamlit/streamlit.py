...
with st.expander("General Streamlit functionalities", expanded=True):
    ...
    with st.expander(
        "Input widgets (buttons): `st.button()`, `st.download_button()`, `st.form_submit_button()`",
    ):
        st.markdown(
            """
        **What they do in general:**
    ...
    with st.expander(
        "Input widgets (selections): `st.checkbox()`, `st.color_picker()`, `st.feedback()`, `st.multiselect()`, `st.radio()`, `st.segmented_control()`, `st.selectbox()`, `st.select_slider()`, `st.toggle()`",
    ):
        st.markdown(
            """
        **What they do in general:**
    ...
    with st.expander(
        "Input widgets (others): `st.chat_input()`, `st.text_area()`, `st.text_input()`, and `st.file_uploader()`",
    ):
        st.markdown(
            """
        **What they do in general:**
    ...
    with st.expander(
        "Media elements: `st.audio()`, `st.image()`, `st.logo()`, `st.video()`",
    ):
        st.markdown(
            """
        **What they do in general:**
    ...
    with st.expander(
        "Layouts and containers: `st.columns()`, `st.container()`, `st.dialog()`, `st.expander()`, `st.form()`, `st.sidebar()`",
    ):
        st.markdown(
            """
        **What they do in general:**
    ...
    with st.expander(
        "Status elements: `st.success()`, `st.info()`, `st.warning()`, `st.error()`, `st.progress()`, `st.spinner()`",
    ):
        st.markdown(
            """
        **What they do in general:**
    ...
    with st.expander(
        "Caching and state: `st.cache_data()`, `st.cache_resource()`, `st.session_state()`, `st.query_params()`",
    ):
        st.markdown(
            """
        **What they do in general:**
...
with st.expander("External Streamlit-related Libraries:", expanded=True):
    ...
    with st.expander("streamlit_autorefresh"):
        ...
        **Where it's used:**
        ...
        st.warning(
            "Note: might be replaced by `st.fragment()` in the future, which is part of Streamlit itself.",
            icon="⚠️",
        )
